<div>
    ...
    <div class="mb-5 flex gap-1 overflow-x-auto border-b border-slate-200">
        @foreach (['all'=>'الكل','unread'=>'غير المقروءة','tasks'=>'المهام','hr'=>'الموارد البشرية','finance'=>'المالية','subscriptions'=>'الاشتراكات','whatsapp'=>'واتساب'] as $key=>$label)
    ...
    <x-modal show="showPrefs" title="تفضيلات الإشعارات">
        ...
        <div class="space-y-2">
            @foreach (['tasks'=>'المهام','hr'=>'الموارد البشرية','finance'=>'المالية','subscriptions'=>'الاشتراكات','whatsapp'=>'إخفاقات واتساب'] as $key=>$label)
